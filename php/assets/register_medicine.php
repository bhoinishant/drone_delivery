...
<div>
  ...
  <form method="post" action="register_medicine.php" style="height: 600px;">
    ...
    <div class="form-group ">
               ...
               <div class="input-group">
            <button type="submit" style="background-color: #FF5900; width: 620px;" class="btn" name="summit">Register</button>
        </div>
